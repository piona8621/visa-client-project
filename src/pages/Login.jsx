...
// const Login = () => {
//   const { signInUser, googleSignIn, setUser } = useContext(AuthContext); // setUser added
...
//         setUser(result.user); // Set user in AuthContext
...
import animationData from "../assets/animation/userlogin.json";
...
const Login = () => {
  ...
  return (
    <>
      ...
      <Navbar />
      <div className="text-white py-12">
        <div className="flex justify-center ml-20 mt-5 items-center flex-col lg:flex-row">
          {/* Left Side: Login Form */}
          <div className="lg:w-1/2 bg-blue-900 opacity-90 shadow-2xl p-8 rounded-lg">
            <h1 className="text-3xl sm:text-4xl text-center font-mono text-white font-bold mb-4">
              Login
            </h1>
            <form onSubmit={handleSignIn} className="space-y-4">
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-white text-lg font-mono">
                    Email
                  </span>
                </label>
                <input
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-mono text-lg text-white font-medium">
                    Password
                  </span>
                </label>
                <input
              ...
              <div className="form-control mt-6">
                <button className="btn text-lg text-white font-mono bg-red-600 font-bold w-full py-3">
                  Login
                </button>
              </div>
            </form>
